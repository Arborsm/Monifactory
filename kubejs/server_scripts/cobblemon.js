...
ServerEvents.recipes(event => {
    ...
    addASSRecipe(['heal_ball'], ['cobblemon:pink_apricorn', 'cobblemon:white_apricorn', 'gtceu:copper_plate', 'gtceu:iron_ring', '#gtceu:circuits/lv'], ['cobblemon:heal_ball'], ['gtceu:medicinal_brew 200'], [], LV, 6, 2)
    addASSRecipe(['safari_ball'], ['cobblemon:green_apricorn', 'cobblemon:yellow_apricorn', 'gtceu:copper_plate', 'gtceu:iron_ring', '#gtceu:circuits/lv'], ['cobblemon:safari_ball'], [], [], LV, 6, 2)
    ...
    addASSRecipe(['great_ball'], ['cobblemon:red_apricorn', 'cobblemon:blue_apricorn', '2x gtceu:iron_plate', 'gtceu:steel_ring', '#gtceu:circuits/mv'], ['cobblemon:great_ball'], ['gtceu:tin 200'], [], MV, 8, 1)
    ...
    addASSRecipe(['dusk_ball'], ['cobblemon:black_apricorn', 'cobblemon:green_apricorn', '2x gtceu:titanium_plate', 'gtceu:stainless_steel_ring', '#gtceu:circuits/hv'], ['cobblemon:dusk_ball'], ['gtceu:rose_gold 200'], [], EV, 16, 1)
    ...
    addASSRecipe(['quick_ball'], ['cobblemon:blue_apricorn', 'cobblemon:yellow_apricorn', '2x gtceu:titanium_plate', 'gtceu:stainless_steel_ring', '#gtceu:circuits/hv'], ['cobblemon:quick_ball'], ['gtceu:rose_gold 200'], [], EV, 16, 2)
    ...
    addASSRecipe(['dream_ball'], ['2x cobblemon:pink_apricorn', 'cobblemon:red_apricorn', '2x gtceu:tungsten_steel_plate', 'gtceu:tungsten_steel_ring', '#gtceu:circuits/iv'], ['cobblemon:dream_ball'], ['gtceu:polytetrafluoroethylene 200'], [], IV, 20, 2)
